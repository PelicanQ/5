...
import numpy as np
from constants import (D1, D2, T_inf, a_c, cp1, cp2, h_flow, ny2, rho1, rho2, thickness, T_0, E1, E2, ny1, ny2, ptype, ep, alfa1, alfa2)
...
von_mises = []
#vad ska ed vara???
##ed = cfc.extract_ed(edof, temps_stat)
